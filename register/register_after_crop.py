...
# src_dir = '/share/ymz/valisProject/data/mIF_175_converted_cropped/images'
...
def register_one_patient(patient_name: str):
    ...
    registrar = registration.Valis(slide_src_dir, results_dst_dir, imgs_ordered=True, thumbnail_size=2048, series=0)
