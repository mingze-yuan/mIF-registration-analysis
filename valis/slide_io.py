...
class BioFormatsSlideReader(SlideReader):
    ...
    def __init__(self, src_f, series=None, *args, **kwargs):
        ...
        if series is None:
            ...
            # series = 2
            msg = (f"[Modified for convenience] No series provided. "
                   f"Selecting the default series, "
...
def convert_to_ome_tiff(src_f, dst_f, level, series=None, xywh=None,
    ...
    # vips_img = vips_img.fliphor()
    # print(vips_img.shape)
    # vips_img = vips_img.flip
